...
enum class Message {
    ...
    YOU_HAVE_BEEN_HEALED,
    INVENTORY_RESET,
    PERFECT_HORSE_SPAWNED,
    ...
    LEADERBOARD_TIME_DAILY,
    LEADERBOARD_TIME_WEEKLY,
    LEADERBOARD_TIME_ALL_TIME,
    ...
    DEATH_SHOT_BY,
    DEATH_SHOT_BY_WITH_ITEM,
    DEATH_SNIPED_BY,
    DEATH_SNIPED_BY_WITH_ITEM,
    DEATH_KILLED_BY,
    DEATH_KILLED_BY_WITH_ITEM,
    DEATH_EXPLODED,
    DEATH_EXPLODED_BY,
    DEATH_EXPLODED_BY_WITH_ITEM,
    DEATH_BURNED,
    DEATH_BURNED_FIGHTING_AGAINST,
    DEATH_DROWNED,
    DEATH_DROWNED_FIGHTING_AGAINST,
    DEATH_FELL,
    DEATH_FELL_FIGHTING_AGAINST,
    DEATH_LAVA,
    DEATH_LAVA_FIGHTING_AGAINST,
    DEATH_LAVA_FIGHTING_AGAINST_WITH_ITEM,
    DEATH_CACTUS,
    DEATH_CACTUS_FIGHTING_AGAINST,
    DEATH_LIGHTNING,
    DEATH_LIGHTNING_FIGHTING_AGAINST,
    DEATH_SMASHED_BY,
    DEATH_SMASHED_BY_WITH_ITEM,
    DEATH_CRUSHED,
    DEATH_CRUSHED_FIGHTING_AGAINST,
    DEATH_WORLD_BORDER,
    DEATH_WORLD_BORDER_FIGHTING_AGAINST,
    DEATH_KILLED_SELF,
    DEATH_UNKNOWN,
    DEATH_UNKNOWN_FIGHTING_AGAINST,
    ...
    YOU_LOSE,
    GAME_DRAWN,
    GAME_DRAWN_BY_STALEMATE,
    GAME_DRAWN_BY_MUTUAL_DESTRUCTION,
